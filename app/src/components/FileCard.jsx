...
const File = ({ /* Add any necessary props here */ }) => {
    return (
      <div className="bg-white p-6 w-10/12 h-16 rounded-lg border-grey-200 border-2 flex items-center">
        ...
        <div className="ml-4">
          <span className="block text-lg font-semibold">File Name</span>
